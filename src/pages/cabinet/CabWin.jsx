                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="cab_mes_1">
                                <div className="cab_mes_1_name">Yutuqlar</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="cab_mes_search_box">
                    <div className="container">
                        <div className="row d-flex justify-content-center">
                            <div className="cab_mes_inp_box col-lg-6 col-md-6 col-12 d-flex justify-content-center">
                                <input
                            ...
                            <div className="cab_mes_btn col-lg-6 col-md-6 col-12">
                ...
                <div className="cab_mes_box_2">
                    <div className="container">
                        <div className="row justify-content-between ">
                            <div className="col-lg-5 col-12 h_prod_top">
                                <div className="prod_box">
                                    ...
                                    <div className="prod_box_main">
                                        ...
                                        <button className="prod_box_main_btn">
                                            Batafsil
                                        </button>
                                    </div>
                                </div>
